...
namespace eSunSpeed.BusinessLogic
{
    public class TaxCategoryBL
    {
        ...
        public TaxCategoryModel GetTaxDetailsById(int TaxId)
        {
            ...
            objTax.LocalTax = Convert.ToDecimal(dr["LocalTax"]);
            objTax.Description = dr["Description"].ToString();
            objTax.TaxationType = dr["TaxationType"].ToString();
           // objTax.TaxCatType = dr["TaxCatType"].ToString();
