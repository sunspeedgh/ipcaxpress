namespace IPCAUI.Reports.Accountbooks.Grids
{
    partial class ProfitLossGrd
    {
        ...
        private void InitializeComponent()
        {
            ...
            // debit
            // 
            this.debit.Caption = "DEBIT(Rs.)";
            this.debit.FieldName = "Debit";
            this.debit.Name = "debit";
            this.debit.Visible = true;
            this.debit.VisibleIndex = 0;
            // 
            // credit
            // 
            this.credit.Caption = "CREDIT(Rs.)";
            this.credit.FieldName = "Credit";
            this.credit.Name = "credit";
            this.credit.Visible = true;
            this.credit.VisibleIndex = 1;
            // 
            // navBarControl1
            // 
